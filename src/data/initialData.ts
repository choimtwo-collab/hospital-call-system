...
export function getRelatedRoleKeys(role: string): string[] {
  ...
  if (clean.includes('비내과') || clean.includes('non')) {
    ...
    if (clean.includes('당직1') || clean.includes('당직인턴1')) {
      ...
      keys.add('당직 2');
      keys.add('당직2');
    } else if (clean.includes('1') || clean.includes('주간1') || clean.includes('인턴1')) {
      keys.add('내과 1 (주간)');
      keys.add(ROLES.IM_1); // '내과1 (인턴1)'
      keys.add('내과 1');
      keys.add('내과1');
      keys.add('인턴1');
    } else if (clean.includes('2') || clean.includes('주간2') || clean.includes('인턴2')) {
      keys.add('내과 2 (주간)');
  ...
  } else if (clean.includes('심장') || clean.includes('cv') || clean.includes('순환기')) {
    keys.add('심장내과');
    keys.add('cv 분과');
    keys.add('cv분과');
    keys.add('cv');
    keys.add('순환기내과');
  } else if (clean.includes('호흡기') || clean.includes('imr') || clean.includes('pulmo')) {
    keys.add('호흡기내과');
    keys.add('imr 분과');
    keys.add('imr분과');
    keys.add('imr');
...
export const initialDutyRoles: string[] = [
  '내과 1 (주간)',
  '내과 2 (주간)',
  '심장내과',
  '호흡기내과',
...
export const initialSchedules: DateScheduleMap = {
  '2026-09-01': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '', '내과당직 2': '이준재',
    '내과 1': '이준재', '내과 2': '', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '', '내과인턴당직2': '이준재',
    '비내과 1': '신유경', '비내과 2': '전하윤', '비내과 3': '권민재',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '신유경', [ROLES.NON_IM_2]: '전하윤', [ROLES.NON_IM_3]: '권민재'
  },
  '2026-09-02': {
    '내과 1 (주간)': '정소영', '내과 2 (주간)': '박신희', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '정소영', '내과당직 2': '박신희',
    '내과 1': '정소영', '내과 2': '박신희', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '정소영', '내과인턴당직2': '박신희',
    '비내과 1': '배규리', '비내과 2': '최남석', '비내과 3': '이태겸',
    [ROLES.IM_1]: '정소영', [ROLES.IM_2]: '박신희', [ROLES.IM_DUTY_1]: '정소영', [ROLES.IM_DUTY_2]: '박신희',
    [ROLES.NON_IM_1]: '배규리', [ROLES.NON_IM_2]: '최남석', [ROLES.NON_IM_3]: '이태겸'
  },
  '2026-09-03': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '전지연', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '전지연', '내과당직 2': '이준재',
    '내과 1': '이준재', '내과 2': '전지연', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '전지연', '내과인턴당직2': '이준재',
    '비내과 1': '이창윤', '비내과 2': '전하윤', '비내과 3': '천지원',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '전지연', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '이창윤', [ROLES.NON_IM_2]: '전하윤', [ROLES.NON_IM_3]: '천지원'
  },
  '2026-09-04': {
    '내과 1 (주간)': '박신희', '내과 2 (주간)': '정소영', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '정소영', '내과당직 2': '박수현',
    '내과 1': '박신희', '내과 2': '정소영', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '정소영', '내과인턴당직2': '박수현',
    '비내과 1': '신유경', '비내과 2': '권민재', '비내과 3': '이태겸',
    [ROLES.IM_1]: '박신희', [ROLES.IM_2]: '정소영', [ROLES.IM_DUTY_1]: '정소영', [ROLES.IM_DUTY_2]: '박수현',
    [ROLES.NON_IM_1]: '신유경', [ROLES.NON_IM_2]: '권민재', [ROLES.NON_IM_3]: '이태겸'
  },
  '2026-09-05': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '이준재', '내과당직 2': '신정민',
    '내과 1': '이준재', '내과 2': '신정민', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '이준재', '내과인턴당직2': '신정민',
    '비내과 1': '최남석', '비내과 2': '이상엽', '비내과 3': '이창윤',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '이준재', [ROLES.IM_DUTY_2]: '신정민',
    [ROLES.NON_IM_1]: '최남석', [ROLES.NON_IM_2]: '이상엽', [ROLES.NON_IM_3]: '이창윤'
  },
  '2026-09-06': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '전지연', '내과당직 2': '박수현',
    '내과 1': '전지연', '내과 2': '박수현', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '전지연', '내과인턴당직2': '박수현',
    '비내과 1': '전하윤', '비내과 2': '배규리', '비내과 3': '천지원',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '박수현',
    [ROLES.NON_IM_1]: '전하윤', [ROLES.NON_IM_2]: '배규리', [ROLES.NON_IM_3]: '천지원'
  },
  '2026-09-07': {
    '내과 1 (주간)': '정소영', '내과 2 (주간)': '이준재', '심장내과': '신정민', '호흡기내과': '박신희', '내과당직 1': '정소영', '내과당직 2': '신정민',
    '내과 1': '정소영', '내과 2': '이준재', 'cv 분과': '신정민', 'imr 분과': '박신희', '내과인턴당직1': '정소영', '내과인턴당직2': '신정민',
    '비내과 1': '권민재', '비내과 2': '이상엽', '비내과 3': '최남석',
    [ROLES.IM_1]: '정소영', [ROLES.IM_2]: '이준재', [ROLES.IM_DUTY_1]: '정소영', [ROLES.IM_DUTY_2]: '신정민',
    [ROLES.NON_IM_1]: '권민재', [ROLES.NON_IM_2]: '이상엽', [ROLES.NON_IM_3]: '최남석'
  },
  '2026-09-08': {
    '내과 1 (주간)': '박신희', '내과 2 (주간)': '이준재', '심장내과': '전지연', '호흡기내과': '박수현', '내과당직 1': '박신희', '내과당직 2': '이준재',
    '내과 1': '박신희', '내과 2': '이준재', 'cv 분과': '전지연', 'imr 분과': '박수현', '내과인턴당직1': '박신희', '내과인턴당직2': '이준재',
    '비내과 1': '이창윤', '비내과 2': '천지원', '비내과 3': '신유경',
    [ROLES.IM_1]: '박신희', [ROLES.IM_2]: '이준재', [ROLES.IM_DUTY_1]: '박신희', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '이창윤', [ROLES.NON_IM_2]: '천지원', [ROLES.NON_IM_3]: '신유경'
  },
  '2026-09-09': {
    '내과 1 (주간)': '전지연', '내과 2 (주간)': '정소영', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '전지연', '내과당직 2': '정소영',
    '내과 1': '전지연', '내과 2': '정소영', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '전지연', '내과인턴당직2': '정소영',
    '비내과 1': '이상엽', '비내과 2': '배규리', '비내과 3': '이태겸',
    [ROLES.IM_1]: '전지연', [ROLES.IM_2]: '정소영', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '정소영',
    [ROLES.NON_IM_1]: '이상엽', [ROLES.NON_IM_2]: '배규리', [ROLES.NON_IM_3]: '이태겸'
  },
  '2026-09-10': {
    '내과 1 (주간)': '박신희', '내과 2 (주간)': '이준재', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '박신희', '내과당직 2': '박수현',
    '내과 1': '박신희', '내과 2': '이준재', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '박신희', '내과인턴당직2': '박수현',
    '비내과 1': '전하윤', '비내과 2': '신유경', '비내과 3': '권민재',
    [ROLES.IM_1]: '박신희', [ROLES.IM_2]: '이준재', [ROLES.IM_DUTY_1]: '박신희', [ROLES.IM_DUTY_2]: '박수현',
    [ROLES.NON_IM_1]: '전하윤', [ROLES.NON_IM_2]: '신유경', [ROLES.NON_IM_3]: '권민재'
  },
  '2026-09-11': {
    '내과 1 (주간)': '전지연', '내과 2 (주간)': '정소영', '심장내과': '신정민', '호흡기내과': '이준재', '내과당직 1': '전지연', '내과당직 2': '신정민',
    '내과 1': '전지연', '내과 2': '정소영', 'cv 분과': '신정민', 'imr 분과': '이준재', '내과인턴당직1': '전지연', '내과인턴당직2': '신정민',
    '비내과 1': '최남석', '비내과 2': '배규리', '비내과 3': '이태겸',
    [ROLES.IM_1]: '전지연', [ROLES.IM_2]: '정소영', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '신정민',
    [ROLES.NON_IM_1]: '최남석', [ROLES.NON_IM_2]: '배규리', [ROLES.NON_IM_3]: '이태겸'
  },
  '2026-09-12': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '박수현', '내과당직 2': '정소영',
    '내과 1': '박수현', '내과 2': '정소영', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '박수현', '내과인턴당직2': '정소영',
    '비내과 1': '신유경', '비내과 2': '이창윤', '비내과 3': '이상엽',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '박수현', [ROLES.IM_DUTY_2]: '정소영',
    [ROLES.NON_IM_1]: '신유경', [ROLES.NON_IM_2]: '이창윤', [ROLES.NON_IM_3]: '이상엽'
  },
  '2026-09-13': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '신정민', '내과당직 2': '이준재',
    '내과 1': '신정민', '내과 2': '이준재', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '신정민', '내과인턴당직2': '이준재',
    '비내과 1': '전하윤', '비내과 2': '천지원', '비내과 3': '권민재',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '신정민', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '전하윤', [ROLES.NON_IM_2]: '천지원', [ROLES.NON_IM_3]: '권민재'
  },
  '2026-09-14': {
    '내과 1 (주간)': '박신희', '내과 2 (주간)': '전지연', '심장내과': '정소영', '호흡기내과': '박수현', '내과당직 1': '전지연', '내과당직 2': '박신희',
    '내과 1': '박신희', '내과 2': '전지연', 'cv 분과': '정소영', 'imr 분과': '박수현', '내과인턴당직1': '전지연', '내과인턴당직2': '박신희',
    '비내과 1': '배규리', '비내과 2': '이상엽', '비내과 3': '이창윤',
    [ROLES.IM_1]: '박신희', [ROLES.IM_2]: '전지연', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '박신희',
    [ROLES.NON_IM_1]: '배규리', [ROLES.NON_IM_2]: '이상엽', [ROLES.NON_IM_3]: '이창윤'
  },
  '2026-09-15': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '정소영', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '정소영', '내과당직 2': '이준재',
    '내과 1': '이준재', '내과 2': '정소영', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '정소영', '내과인턴당직2': '이준재',
    '비내과 1': '최남석', '비내과 2': '이태겸', '비내과 3': '전하윤',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '정소영', [ROLES.IM_DUTY_1]: '정소영', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '최남석', [ROLES.NON_IM_2]: '이태겸', [ROLES.NON_IM_3]: '전하윤'
  },
  '2026-09-16': {
    '내과 1 (주간)': '박신희', '내과 2 (주간)': '전지연', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '박수현', '내과당직 2': '박신희',
    '내과 1': '박신희', '내과 2': '전지연', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '박수현', '내과인턴당직2': '박신희',
    '비내과 1': '천지원', '비내과 2': '권민재', '비내과 3': '신유경',
    [ROLES.IM_1]: '박신희', [ROLES.IM_2]: '전지연', [ROLES.IM_DUTY_1]: '박수현', [ROLES.IM_DUTY_2]: '박신희',
    [ROLES.NON_IM_1]: '천지원', [ROLES.NON_IM_2]: '권민재', [ROLES.NON_IM_3]: '신유경'
  },
  '2026-09-17': {
    '내과 1 (주간)': '정소영', '내과 2 (주간)': '전지연', '심장내과': '신정민', '호흡기내과': '이준재', '내과당직 1': '신정민', '내과당직 2': '전지연',
    '내과 1': '정소영', '내과 2': '전지연', 'cv 분과': '신정민', 'imr 분과': '이준재', '내과인턴당직1': '신정민', '내과인턴당직2': '전지연',
    '비내과 1': '이태겸', '비내과 2': '최남석', '비내과 3': '배규리',
    [ROLES.IM_1]: '정소영', [ROLES.IM_2]: '전지연', [ROLES.IM_DUTY_1]: '신정민', [ROLES.IM_DUTY_2]: '전지연',
    [ROLES.NON_IM_1]: '이태겸', [ROLES.NON_IM_2]: '최남석', [ROLES.NON_IM_3]: '배규리'
  },
  '2026-09-18': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '정소영', '심장내과': '박신희', '호흡기내과': '박수현', '내과당직 1': '이준재', '내과당직 2': '박수현',
    '내과 1': '이준재', '내과 2': '정소영', 'cv 분과': '박신희', 'imr 분과': '박수현', '내과인턴당직1': '이준재', '내과인턴당직2': '박수현',
    '비내과 1': '이상엽', '비내과 2': '이창윤', '비내과 3': '유성윤',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '정소영', [ROLES.IM_DUTY_1]: '이준재', [ROLES.IM_DUTY_2]: '박수현',
    [ROLES.NON_IM_1]: '이상엽', [ROLES.NON_IM_2]: '이창윤', [ROLES.NON_IM_3]: '유성윤'
  },
  '2026-09-19': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '박신희', '내과당직 2': '신정민',
    '내과 1': '박신희', '내과 2': '신정민', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '박신희', '내과인턴당직2': '신정민',
    '비내과 1': '권민재', '비내과 2': '신유경', '비내과 3': '배규리',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '박신희', [ROLES.IM_DUTY_2]: '신정민',
    [ROLES.NON_IM_1]: '권민재', [ROLES.NON_IM_2]: '신유경', [ROLES.NON_IM_3]: '배규리'
  },
  '2026-09-20': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '정소영', '내과당직 2': '전지연',
    '내과 1': '정소영', '내과 2': '전지연', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '정소영', '내과인턴당직2': '전지연',
    '비내과 1': '이창윤', '비내과 2': '천지원', '비내과 3': '이상엽',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '정소영', [ROLES.IM_DUTY_2]: '전지연',
    [ROLES.NON_IM_1]: '이창윤', [ROLES.NON_IM_2]: '천지원', [ROLES.NON_IM_3]: '이상엽'
  },
  '2026-09-21': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '박신희', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '박수현', '내과당직 2': '이준재',
    '내과 1': '이준재', '내과 2': '박신희', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '박수현', '내과인턴당직2': '이준재',
    '비내과 1': '이태겸', '비내과 2': '유성윤', '비내과 3': '최남석',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '박신희', [ROLES.IM_DUTY_1]: '박수현', [ROLES.IM_DUTY_2]: '이준재',
    [ROLES.NON_IM_1]: '이태겸', [ROLES.NON_IM_2]: '유성윤', [ROLES.NON_IM_3]: '최남석'
  },
  '2026-09-22': {
    '내과 1 (주간)': '전지연', '내과 2 (주간)': '박신희', '심장내과': '신정민', '호흡기내과': '정소영', '내과당직 1': '박신희', '내과당직 2': '전지연',
    '내과 1': '전지연', '내과 2': '박신희', 'cv 분과': '신정민', 'imr 분과': '정소영', '내과인턴당직1': '박신희', '내과인턴당직2': '전지연',
    '비내과 1': '천지원', '비내과 2': '배규리', '비내과 3': '권민재',
    [ROLES.IM_1]: '전지연', [ROLES.IM_2]: '박신희', [ROLES.IM_DUTY_1]: '박신희', [ROLES.IM_DUTY_2]: '전지연',
    [ROLES.NON_IM_1]: '천지원', [ROLES.NON_IM_2]: '배규리', [ROLES.NON_IM_3]: '권민재'
  },
  '2026-09-23': {
    '내과 1 (주간)': '정소영', '내과 2 (주간)': '이준재', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '신정민', '내과당직 2': '박수현',
    '내과 1': '정소영', '내과 2': '이준재', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '신정민', '내과인턴당직2': '박수현',
    '비내과 1': '신유경', '비내과 2': '이상엽', '비내과 3': '이창윤',
    [ROLES.IM_1]: '정소영', [ROLES.IM_2]: '이준재', [ROLES.IM_DUTY_1]: '신정민', [ROLES.IM_DUTY_2]: '박수현',
    [ROLES.NON_IM_1]: '신유경', [ROLES.NON_IM_2]: '이상엽', [ROLES.NON_IM_3]: '이창윤'
  },
  '2026-09-24': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '이준재', '내과당직 2': '정소영',
    '내과 1': '이준재', '내과 2': '정소영', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '이준재', '내과인턴당직2': '정소영',
    '비내과 1': '최남석', '비내과 2': '이태겸', '비내과 3': '유성윤',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '이준재', [ROLES.IM_DUTY_2]: '정소영',
    [ROLES.NON_IM_1]: '최남석', [ROLES.NON_IM_2]: '이태겸', [ROLES.NON_IM_3]: '유성윤'
  },
  '2026-09-25': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '신정민', '내과당직 2': '박신희',
    '내과 1': '신정민', '내과 2': '박신희', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '신정민', '내과인턴당직2': '박신희',
    '비내과 1': '권민재', '비내과 2': '천지원', '비내과 3': '배규리',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '신정민', [ROLES.IM_DUTY_2]: '박신희',
    [ROLES.NON_IM_1]: '권민재', [ROLES.NON_IM_2]: '천지원', [ROLES.NON_IM_3]: '배규리'
  },
  '2026-09-26': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '박수현', '내과당직 2': '전지연',
    '내과 1': '박수현', '내과 2': '전지연', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '박수현', '내과인턴당직2': '전지연',
    '비내과 1': '이상엽', '비내과 2': '이창윤', '비내과 3': '신유경',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '박수현', [ROLES.IM_DUTY_2]: '전지연',
    [ROLES.NON_IM_1]: '이상엽', [ROLES.NON_IM_2]: '이창윤', [ROLES.NON_IM_3]: '신유경'
  },
  '2026-09-27': {
    '내과 1 (주간)': '', '내과 2 (주간)': '', '심장내과': '', '호흡기내과': '', '내과당직 1': '박신희', '내과당직 2': '정소영',
    '내과 1': '박신희', '내과 2': '정소영', 'cv 분과': '', 'imr 분과': '', '내과인턴당직1': '박신희', '내과인턴당직2': '정소영',
    '비내과 1': '천지원', '비내과 2': '최남석', '비내과 3': '유성윤',
    [ROLES.IM_1]: '', [ROLES.IM_2]: '', [ROLES.IM_DUTY_1]: '박신희', [ROLES.IM_DUTY_2]: '정소영',
    [ROLES.NON_IM_1]: '천지원', [ROLES.NON_IM_2]: '최남석', [ROLES.NON_IM_3]: '유성윤'
  },
  '2026-09-28': {
    '내과 1 (주간)': '전지연', '내과 2 (주간)': '이준재', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '이준재', '내과당직 2': '전지연',
    '내과 1': '전지연', '내과 2': '이준재', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '이준재', '내과인턴당직2': '전지연',
    '비내과 1': '배규리', '비내과 2': '권민재', '비내과 3': '이태겸',
    [ROLES.IM_1]: '전지연', [ROLES.IM_2]: '이준재', [ROLES.IM_DUTY_1]: '이준재', [ROLES.IM_DUTY_2]: '전지연',
    [ROLES.NON_IM_1]: '배규리', [ROLES.NON_IM_2]: '권민재', [ROLES.NON_IM_3]: '이태겸'
  },
  '2026-09-29': {
    '내과 1 (주간)': '정소영', '내과 2 (주간)': '박신희', '심장내과': '신정민', '호흡기내과': '박수현', '내과당직 1': '신정민', '내과당직 2': '정소영',
    '내과 1': '정소영', '내과 2': '박신희', 'cv 분과': '신정민', 'imr 분과': '박수현', '내과인턴당직1': '신정민', '내과인턴당직2': '정소영',
    '비내과 1': '천지원', '비내과 2': '신유경', '비내과 3': '최남석',
    [ROLES.IM_1]: '정소영', [ROLES.IM_2]: '박신희', [ROLES.IM_DUTY_1]: '신정민', [ROLES.IM_DUTY_2]: '정소영',
    [ROLES.NON_IM_1]: '천지원', [ROLES.NON_IM_2]: '신유경', [ROLES.NON_IM_3]: '최남석'
  },
  '2026-09-30': {
    '내과 1 (주간)': '이준재', '내과 2 (주간)': '박신희', '심장내과': '전지연', '호흡기내과': '박수현', '내과당직 1': '전지연', '내과당직 2': '박신희',
    '내과 1': '이준재', '내과 2': '박신희', 'cv 분과': '전지연', 'imr 분과': '박수현', '내과인턴당직1': '전지연', '내과인턴당직2': '박신희',
    '비내과 1': '이태겸', '비내과 2': '이창윤', '비내과 3': '이상엽',
    [ROLES.IM_1]: '이준재', [ROLES.IM_2]: '박신희', [ROLES.IM_DUTY_1]: '전지연', [ROLES.IM_DUTY_2]: '박신희',
    [ROLES.NON_IM_1]: '이태겸', [ROLES.NON_IM_2]: '이창윤', [ROLES.NON_IM_3]: '이상엽'
  }
};
